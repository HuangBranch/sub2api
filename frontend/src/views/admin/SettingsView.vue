            ...
            <div class="space-y-6 p-6">
              ...
              <div>
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                  {{ t("admin.settings.site.ccsDefaultModel") }}
                </label>
                <input
                  v-model.trim="form.ccs_default_model"
                  type="text"
                  class="input font-mono text-sm"
                  :placeholder="
                    t('admin.settings.site.ccsDefaultModelPlaceholder')
                  "
                />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.site.ccsDefaultModelHint") }}
                </p>
              </div>
...
const form = reactive<SettingsForm>({
  ...
  api_base_url: "",
  ccs_default_model: OPENAI_CC_SWITCH_CODEX_MODEL,
  contact_info: "",
  doc_url: "",
  home_content: "",
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      ccs_default_model: form.ccs_default_model,
