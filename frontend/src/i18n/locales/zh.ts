  ...
  admin: {
    ...
    accounts: {
      ...
      alertConfig: {
        menuTitle: '账号告警配置',
        title: '账号告警配置',
        description: '当账号定时检测失败、触发限流、进入错误状态，或可调度账号数量不足时，通过邮件提醒管理员。',
        enabled: '启用账号告警',
