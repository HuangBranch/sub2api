  ...
  admin: {
    ...
    accounts: {
      ...
      alertConfig: {
        ...
        description: 'Send email alerts when scheduled account checks fail, accounts are rate-limited, accounts enter error state, or available account count is too low.',
        ...
        cooldownHint: 'The same type of issue is only sent once during the cooldown window.',
        ...
        rateLimitFailureHint: 'Alert when the failure message contains 429 or rate-limit signals.',
        ...
        minAvailableAccountsHint: 'Periodically check schedulable account count and alert below the threshold.',
