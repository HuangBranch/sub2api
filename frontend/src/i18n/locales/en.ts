  ...
  admin: {
    ...
    users: {
      ...
      platformQuota: {
        ...
        clearAllConfirm: 'Clear daily / weekly / monthly quotas for all platforms? All platforms will become unlimited. This cannot be undone locally unless you refill values before saving.',
        reset: {
          button: 'Reset this window',
          confirm: 'Reset {platform} {window} usage for this user? This takes effect immediately.',
        ...
        hint: 'Empty = no limit for that window; 0 = disable that platform window.',
        windowDaily: 'daily',
        windowWeekly: 'weekly',
    ...
    accounts: {
      ...
      selectedCount: '{count} selected',
      alertConfig: {
        menuTitle: 'Account Alert Config',
        title: 'Account Alert Config',
        description: 'Send email alerts when scheduled account checks fail, accounts are limited, accounts enter error state, limits recover, or global/group available account count is too low.',
        enabled: 'Enable account alerts',
        enabledHint: 'When disabled, account unavailable, rate-limit, and low-availability alerts will not be sent.',
        recipientsTitle: 'Recipients',
        useOpsRecipients: 'Use ops recipients',
        useOpsRecipientsHint: 'Reuse the email notification recipients configured in Ops Monitoring.',
        extraRecipients: 'Extra recipients',
        extraRecipientsPlaceholder: 'One email per line, commas are also supported',
        extraRecipientsHint: 'Extra recipients are merged with ops recipients and deduplicated.',
        cooldownTitle: 'Frequency',
        cooldownMinutes: 'Cooldown minutes',
        checkIntervalMinutes: 'Count check interval',
        cooldownHint: 'Scheduled test failures still use the cooldown window. Account limits send once per limited period, then send a recovery alert when cleared.',
        rulesTitle: 'Alert rules',
        scheduledTestFailure: 'Scheduled test failure',
        scheduledTestFailureHint: 'Alert when an account scheduled test fails.',
        rateLimitFailure: 'Account rate limit',
        rateLimitFailureHint: 'Alert when an account enters a rate-limit, overload, or temporary unschedulable window; recovery is also alerted.',
        errorFailure: 'Account error/unavailable',
        errorFailureHint: 'Alert when the account enters error state or fails for non-rate-limit reasons.',
        minAvailableAccounts: 'Low available accounts',
        minAvailableAccountsHint: 'Periodically check global and per-group schedulable account count and alert below the threshold.',
        minAvailableThreshold: 'Minimum schedulable accounts',
        loadFailed: 'Failed to load account alert config',
        saveSuccess: 'Account alert config saved',
        saveFailed: 'Failed to save account alert config'
      },
      ...
      refreshTokenSuccess: 'Account token refreshed successfully',
      refreshTokenFailed: 'Failed to refresh account token',
      refreshTokenNeedsReauth: 'This account refresh token is invalid or has already been used. Use Re-authorize to obtain a new token.',
      ...
      bulkDataImportTitle: 'Bulk Import',
      bulkDataImportHint: 'Choose one or more account export JSON files. Each file is imported with the same logic as normal import.',
      bulkDataImportWarning: 'Import will create accounts and proxies from the selected files. Only JSON files exported from normal export are supported; text paste is not supported.',
      bulkDataImportFiles: 'JSON files',
      bulkDataImportButton: 'Start Import',
      bulkDataImporting: 'Importing...',
      bulkDataImportSelectFiles: 'Please select JSON files',
      bulkDataImportSelectedFiles: '{count} file(s) selected',
      bulkDataImportEmptyFile: 'File is empty',
      bulkDataImportParseFailed: 'JSON parse failed',
      bulkDataImportFailed: 'Bulk import failed',
      bulkDataImportResult: 'Import Result',
      bulkDataImportResultSummary: 'Files {files_total}, imported {files_imported}, failed {files_failed}; accounts created {account_created}, account failed {account_failed}, proxies created {proxy_created}, proxies reused {proxy_reused}, proxy failed {proxy_failed}',
      bulkDataImportErrors: 'Error Details',
      bulkDataImportSuccess: 'Import completed: files {files_imported}, accounts created {account_created}, proxies created {proxy_created}',
      bulkDataImportCompletedWithErrors: 'Import completed with errors: file failed {files_failed}, account failed {account_failed}, proxy failed {proxy_failed}',
